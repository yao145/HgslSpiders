...
class MysqldbHelper(object):
    ...
    def __init__(self, host="localhost", username="root", password="123456", port=3306, database="jeecmsv8"):
        self.host = host
    ...
    def executeSql(self, sql=''):
        ...
        try:
            ...
            print('MySQL execute failed! ERROR: %s' % (sql))
...
if __name__ == "__main__":
    ...
    key_to_value_ext = {}
    key_to_value_ext["title"] = "测试"
    key_to_value_ext["release_date"] = "2018-08-31"
    key_to_value_ext["is_bold"] = "0"
    key_to_value_ext["need_regenerate"] = "1"
    rowid = mydb.insert(table, key_to_value_ext)
    print("111")
